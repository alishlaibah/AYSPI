            ...
            <div className="hero-demo animate-in">
              <div className="card demo-card">
                ...
                <p className="coldstart-note">
                  First prediction may take 30–60 s while the Render backend wakes up.
                </p>
              </div>
            </div>
            ...
            <div className="build-grid">
              <div className="build-block animate-in animate-in-delay-2">
                ...
                <p className="build-block-text">
                  I wrote a webcam-based data collection script to record and label my own training set. Collected ~200–300 samples per letter. For letters that depend on motion (like J and Z), I captured short frame sequences instead of single snapshots.
                </p>
              </div>
              <div className="build-block animate-in animate-in-delay-2">
